...
import com.tencent.obfuscate.jar.Tools;
...
public class MethodInfo implements Opcodes {
	 ...
	 * 被调用列表
	 */
	public ArrayList<MethodInfo> callers = new ArrayList<MethodInfo>();
	/**
	 * 这个方法里调用的类
	 */
	public ArrayList<MethodInfo> invokers = new ArrayList<MethodInfo>();
	...
	private static String getPackage(String clsName) {
...
//			 return;
//			 }
//			if ((i != insnList.size() - 1)
//					&& Tools.isReturn(insnNode.getOpcode())) {
//				return;
//			}
//			if ((i == insnList.size() - 1)
//					&& !Tools.isReturn(insnNode.getOpcode())) {
